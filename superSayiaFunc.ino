...
void superSayiaLoop() {
    ...
    for (int j=0; j<RL_PIXEL_COUNT; j++){
          ...
          legRight.setPixelColor(j,colorClass.Color(0xFF/5,0xD7/5,0x00));
   
           
    }
          for (int j=0; j<LL_PIXEL_COUNT; j++){
      
          legLeft.setPixelColor(j,colorClass.Color(0xFF/5,0xD7/5,0x00));
   
          }
      for (int j=0; j<B_PIXEL_COUNT; j++){
      
          body.setPixelColor(j,colorClass.Color(0xFF/5,0xD7/5,0x00));
          
   
          } 
      for (int j=0; j<LH_PIXEL_COUNT; j++){
        handLeft.setPixelColor(j,colorClass.Color(0xFF/5,0xD7/5,0x00));
   
          } 
          for (int j=0; j<RH_PIXEL_COUNT; j++){
        handRight.setPixelColor(j,colorClass.Color(0xFF/5,0xD7/5,0x00));

          }
      for (int j=0; j<HE_PIXEL_COUNT; j++){
         head.setPixelColor(j, colorClass.Color(0xFF/5,0xD7/5,0x00));
          }
